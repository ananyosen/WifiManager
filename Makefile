...
run: wifidevice.o manager.o dnsui.o config.o apapplet.o res.o run.o
...
1:
	valac --pkg libnm-glib --pkg dbus-glib-1 --pkg libnm-util --pkg gtk+-3.0 wifidevice.vala manager.vala dnsui.vala config.vala apapplet.vala run.vala --target-glib=2.38 --gresources ./res.xml -C 
# 2:
